...
function buildDetectPrompt(): string {
  ...
  const signals: Record<string, string> = {
    wiedent_classic: "Fasony 3-4 cyfrowe (402, 421, 635, 733), kolory A1-D3, nazwa 'Classic'",
    wiedent_almamiss: "Fasony 3-cyfrowe (210, 320, 650, 790), kolory A1-D4 + OM, nazwa 'Almamiss'",
    wiedent_estetic: "Fasony 2-cyfrowe (12-50, 60-80), kolory A1-B3 + G/N/R (skala W), nazwa 'Estetic'",
    wiedent_estetic_vita: "Te same fasony co Estetic, ale kolory VITA (A1-D4), 'wg Vity'",
    wiedent_estetic_om: "Kolory OM1/OM3/0M1/0M3, 'wybielone', fasony 06/08/010/27/33/36/38/48",
    ivoclar_ivostar: "Kolory Chromascop (XXX/YY) lub VITA, fasony 2-cyfrowe (01-45), 'Ivostar'",
    ivoclar_gnathostar: "Fasony D80-D88 (lub same liczby 80-88), 'Gnathostar' — często z Ivostar",
    ...
    major_super_lux: "Prefiksy 0/1, fasony 0/3-0/11, 50-62, 1/xx, 70N-79N, 'Super Lux'",
    major_composite: "Fasony B/L/M/S + A/T, 'kompozytowe'",
    major_dent: "Fasony 2-cyfrowe + litery (7A, 19A), kolory VITA + 2C-3R, 'Major DENT'",
