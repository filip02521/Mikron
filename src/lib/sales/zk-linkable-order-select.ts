...
export const ZK_LINKABLE_ORDER_SELECT =
  "id, sales_person_id, sales_client_name, sales_client_kh_id, source_zk_watch_id, source_zk_number, subiekt_tw_id, symbol, products, mikran_code, quantity, delivered_quantity, status, request_kind, is_teeth, informacja_stock_out_reorder, ordered_at, action_at, delivery_at, zd_fulfillment_deadline, zd_fulfillment_previous_deadline, zd_fulfillment_deadline_changed_at, zd_fulfillment_deadline_change_seen_at, sales_acknowledged_at, sales_cancelled_at";
...
export const ZK_TEETH_ORDER_SELECT =
  "id, sales_person_id, sales_client_name, sales_client_kh_id, source_zk_watch_id, source_zk_number, subiekt_tw_id, symbol, products, mikran_code, quantity, delivered_quantity, status, request_kind, is_teeth, informacja_stock_out_reorder, teeth_ordered_at, teeth_delivery_date, ordered_at, action_at, delivery_at, zd_fulfillment_deadline, zd_fulfillment_previous_deadline, zd_fulfillment_deadline_changed_at, zd_fulfillment_deadline_change_seen_at, sales_acknowledged_at, sales_cancelled_at";
