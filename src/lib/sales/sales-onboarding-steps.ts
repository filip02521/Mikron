...
export function getSalesOnboardingSteps(role: UserRole): SalesOnboardingStep[] {
  ...
  const steps: SalesOnboardingStep[] = [
    ...
    },
    {
      ...
      bullets: [
        "Na początku wybierasz rodzaj: zamówienie u dostawcy albo informacja — powiadomimy Cię, gdy towar trafi na magazyn (bez zamówienia u dostawcy).",
        "Potem dodajesz produkty — kolejne pozycje przyciskiem „+ Kolejny produkt”, bez osobnych formularzy.",
        "Dostawcy nie wybierasz z listy: wpisujesz symbol, kod Mikran lub opis, a system sam przypisze właściwą firmę (zakupy doprecyzują, gdy czegoś brakuje).",
        "Po wysłaniu w „Moje zamówienia” każdy dostawca ma osobny wiersz — widzisz status każdej sprawy z osobna.",
