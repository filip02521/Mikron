...
export function getSalesOnboardingSteps(role: UserRole): SalesOnboardingStep[] {
  ...
  const steps: SalesOnboardingStep[] = [
    ...
    },
    {
      ...
      href: "/zk",
      title: "ZK czekające",
      lead: "Tu śledzisz zamówienia klientów (ZK) z Subiekta — na co czekasz, co już dotarło na magazyn i skąd wysyłasz prośbę do zakupów. Notatki i archiwum są w osobnych zakładkach.",
      bullets: [
        ...
        "Liczba na zakładce ZK czekające = zaległe przypomnienia (ZK lub notatki).",
      ],
