...
export const MAX_PROCUREMENT_CANCEL_NOTE_LEN = 500;
export const MAX_PROCUREMENT_FLAG_NOTE_LEN = 500;
export const MAX_PROCUREMENT_FLAG_LABEL_LEN = 40;
export const MAX_PROCUREMENT_FLAG_DEFINITIONS = 20;
