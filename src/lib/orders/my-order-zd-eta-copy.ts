...
/** Badge — pełny stan oczekiwania na sync terminu u dostawcy. */
export const ZD_ETA_PENDING_BADGE_LABEL = "Sprawdzamy termin u dostawcy…";

/** Badge — obok szacunku z historii. */
export const ZD_ETA_PENDING_COMPACT_BADGE = "Sprawdzamy termin…";
...
export const ZD_ETA_NO_MATCH_PRIMARY_LABEL = "Brak terminu u dostawcy";
...
export const ZD_ETA_TIMING_TITLE_NO_MATCH = "Brak terminu u dostawcy";
...
export const ZD_ETA_LINE_NO_MATCH_LABEL = "Brak terminu u dostawcy";
