...
export function MobileNavOverflowSheet({
  ...
  const overflowBadgeTotal = items.reduce(
  ...
  return (
    <>
      <li className="min-w-0 flex-1">
        ...
        >
          <span className="relative">
            ...
            {overflowBadgeTotal > 0 && !activeInOverflow ? (
              <span
                className={cn(
      ...
      {open ? (
        <div className="fixed inset-0 z-[60] md:hidden" role="dialog" aria-modal="true" aria-label="Więcej w menu">
          <button
            type="button"
