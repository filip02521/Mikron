    ...
    <Card className="px-4 py-5 sm:px-6">
      ...
      {showActions ? (
        <div className="mt-5 flex flex-wrap justify-center gap-2">
          ...
          <Link
            href="/plan"
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-2.5 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50"
          >
