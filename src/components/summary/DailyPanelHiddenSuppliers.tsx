...
export function DailyPanelHiddenSuppliers({
  ...
  return (
    ...
    >
      <summary className="cursor-pointer list-none border-b border-slate-100 bg-slate-50/50 px-3 py-2 marker:content-none sm:px-4 [&::-webkit-details-marker]:hidden">
