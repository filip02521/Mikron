...
/** Powiadomienia / inbox handlowca */
export function IconBell(props: StrokeIconProps) {
  return (
    <Svg {...props}>
...
export function IconStar({
  ...
  size = 20,
  strokeWidth = 2,
}: StrokeIconProps & { filled?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
/** Notatnik / książka */
export function IconNotebook(props: StrokeIconProps) {
  return (
    <Svg {...props}>
      <path d="M2 6h4M2 10h4M2 14h4M2 18h4" />
      <rect x="6" y="3" width="16" height="18" rx="2" />
      <path d="M10 7h8M10 11h8M10 15h6" />
    </Svg>
  );
}

/** Nowy plik / plus w dokumencie */
export function IconFilePlus(props: StrokeIconProps) {
  return (
    <Svg {...props}>
...
/** Wykres trendu / statystyki miesięczne */
export function IconChartTrend(props: StrokeIconProps) {
  return (
    <Svg {...props}>
      <path d="M3 3v18h18" />
