-- Wspólne (public) notatki działu: każdy z dostępem do działu może edytować / archiwizować.
-- Autor, dział i widoczność są niemutowalne poza adminem (trigger).
  ...
  FOR UPDATE USING (
    ...
    OR (
      ...
      AND (
        ...
        OR visibility = 'public'::operations_note_visibility
      )
    )
  )
  WITH CHECK (
